...
const ProfilePage = () => {
  ...
  const [name, setName] = useState("Nitesh Pandey");
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // later this will be API request
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 flex-1">
          ...
          >
            ...
            <img
              ...
              alt="profile"
              className={`w-16 h-16 object-cover border border-white/30 shadow-md ${
          ...
          <button
            type="submit"
            className="py-3 rounded-lg bg-gradient-to-r from-purple-500 to-indigo-600 shadow-lg hover:scale-105 transition font-medium"
          >
            Save Changes
          </button>
